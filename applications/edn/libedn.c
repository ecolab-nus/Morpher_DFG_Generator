...
*****************************************************/
__attribute__((annotate("d:200,r:200")))
void
...
__attribute__((annotate("d:200,r:200")))
void
jpegdct_unrolled_2 (short *d, short *r)
{
  long int t[12];
  long int t_2[12];
  short i, j, k, m, n, p;
  for (k = 1, m = 0, n = 13, p = 8; k <= 8*2;
       k += 7*2, m += 3, n += 3, p -= 7, d -= 64)
    {
      for (i = 0; i < 8; i++, d += p)
  {
    for (j = 0; j < 4; j++)
      {
        t[j] = d[k * j] + d[k * (7 - j)];
        t[7 - j] = d[k * j] - d[k * (7 - j)];
        t_2[j] = d[(k + 7) * j] + d[(k+7) * (7 - j)];
        t_2[7 - j] = d[(k+7) * j] - d[(k+7) * (7 - j)];
      }
          #ifdef CGRA_COMPILER
           please_map_me();
           #endif
    ...
    t_2[11] = t_2[1] - t_2[2];
    d[0] = (t_2[8] + t_2[10]) >> m;
    d[4 * (k+7)] = (t_2[8] - t_2[10]) >> m;
    t_2[8] = (short) (t_2[11] + t_2[9]) * r[10];
    d[2 * (k+7)] = t_2[8] + (short) ((t_2[9] * r[9]) >> n);
    d[6 * (k+7)] = t_2[8] + (short) ((t_2[11] * r[11]) >> n);
    t_2[0] = (short) (t_2[4] + t_2[7]) * r[2];
    t_2[1] = (short) (t_2[5] + t_2[6]) * r[0];
    t_2[2] = t_2[4] + t_2[6];
    t_2[3] = t_2[5] + t_2[7];
    t_2[8] = (short) (t_2[2] + t_2[3]) * r[8];
    t_2[2] = (short) t_2[2] * r[1] + t_2[8];
    t_2[3] = (short) t_2[3] * r[3] + t_2[8];
    d[7 * (k+7)] = (short) (t_2[4] * r[4] + t_2[0] + t_2[2]) >> n;
    d[5 * (k+7)] = (short) (t_2[5] * r[6] + t_2[1] + t_2[3]) >> n;
    d[3 * (k+7)] = (short) (t_2[6] * r[5] + t_2[1] + t_2[2]) >> n;
    d[1 * (k+7)] = (short) (t_2[7] * r[7] + t_2[0] + t_2[3]) >> n;
  }
    }
}
...
__attribute__((annotate("d:200,r:200")))
void
jpegdct_unrolled_3 (short *d, short *r)
{
  long int t[12];
  long int t_2[12];
  long int t_3[12];
  short i, j, k, m, n, p;
  for (k = 1, m = 0, n = 13, p = 8; k <= 8*3;
       k += 7*3, m += 3, n += 3, p -= 7, d -= 64)
    {
      for (i = 0; i < 8; i++, d += p)
  {
    for (j = 0; j < 4; j++)
      {
        ...
        t_2[j] = d[(k + 7) * j] + d[(k+7) * (7 - j)];
        t_2[7 - j] = d[(k+7) * j] - d[(k+7) * (7 - j)];
        t_3[j] = d[(k + 14) * j] + d[(k+14) * (7 - j)];
        t_3[7 - j] = d[(k+14) * j] - d[(k+14) * (7 - j)];
      }
          #ifdef CGRA_COMPILER
           please_map_me();
           #endif
    ...
    t_3[11] = t_3[1] - t_3[2];
    d[0] = (t_3[8] + t_3[10]) >> m;
    d[4 * (k+14)] = (t_3[8] - t_3[10]) >> m;
    t_3[8] = (short) (t_3[11] + t_3[9]) * r[10];
    d[2 * (k+14)] = t_3[8] + (short) ((t_3[9] * r[9]) >> n);
    d[6 * (k+14)] = t_3[8] + (short) ((t_3[11] * r[11]) >> n);
    t_3[0] = (short) (t_3[4] + t_3[7]) * r[2];
    t_3[1] = (short) (t_3[5] + t_3[6]) * r[0];
    t_3[2] = t_3[4] + t_3[6];
    t_3[3] = t_3[5] + t_3[7];
    t_3[8] = (short) (t_3[2] + t_3[3]) * r[8];
    t_3[2] = (short) t_3[2] * r[1] + t_3[8];
    t_3[3] = (short) t_3[3] * r[3] + t_3[8];
    d[7 * (k+14)] = (short) (t_3[4] * r[4] + t_3[0] + t_3[2]) >> n;
    d[5 * (k+14)] = (short) (t_3[5] * r[6] + t_3[1] + t_3[3]) >> n;
    d[3 * (k+14)] = (short) (t_3[6] * r[5] + t_3[1] + t_3[2]) >> n;
    d[1 * (k+14)] = (short) (t_3[7] * r[7] + t_3[0] + t_3[3]) >> n;
  }
    }
}
...
main (void)
{
   benchmark_body (LOCAL_SCALE_FACTOR * 50);
}
