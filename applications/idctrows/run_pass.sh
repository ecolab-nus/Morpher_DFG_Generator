...
rm *_munittrace.log
rm memtraces/*
clang -D CGRA_COMPILER -target i386-unknown-linux-gnu -c -emit-llvm -O2 -fno-tree-vectorize  -mllvm -inline-threshold=100 -fno-unroll-loops libpicojpeg.c -S -o libpicojpeg.ll
