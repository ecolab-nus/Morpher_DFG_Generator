...
rm *_munittrace.log
rm memtraces/*
clang -D CGRA_COMPILER -target i386-unknown-linux-gnu -c -emit-llvm -O2 -fno-tree-vectorize -fno-inline -fno-unroll-loops hpcg.c -S -o integer_fft.ll
#opt -gvn -mem2reg -memdep -memcpyopt -loop-simplify -licm -loop-deletion -indvars -simplifycfg -mergereturn -indvars integer_fft.ll -S -o integer_fft_gvn.ll
opt -gvn -mem2reg -memdep -memcpyopt -loop-simplify -licm -loop-deletion -indvars -simplifycfg -mergereturn -indvars integer_fft.ll -S -o integer_fft_gvn.ll
