...
rm *_munittrace.log
rm memtraces/*
clang -D CGRA_COMPILER -target i386-unknown-linux-gnu -c -emit-llvm -O2 -fno-tree-vectorize -fno-inline -fno-unroll-loops MadgwickAHRS.c -S -o integer_fft.ll
...
opt -load ../../build/skeleton/libSkeletonPass.so -fn MadgwickAHRSupdateIMU -skeleton integer_fft_gvn.ll -S -o integer_fft_gvn_instrument.ll
