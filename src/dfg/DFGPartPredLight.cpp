...
// void DFGPartPredLight::connectBB() {
...
// void DFGPartPredLight::removeOutLoopLoad() {
...
// std::vector<dfgNode*> DFGPartPredLight::getStoreInstructions(BasicBlock* BB) {
 ...
 *
 * */
// int DFGPartPredLight::handlePHINodes(std::set<BasicBlock*> LoopBB) {
...
// dfgNode* DFGPartPredLight::getStartNode(BasicBlock* BB, dfgNode* PHINode) {
...
// dfgNode* DFGPartPredLight::insertMergeNode(dfgNode* PHINode, dfgNode* ctrl, bool controlVal, dfgNode* data) {
...
// dfgNode* DFGPartPredLight::insertMergeNodeBeforeSEL(dfgNode* SELNode, dfgNode* ctrl, bool controlVal, dfgNode* data) {//for select Node
// 	dfgNode* temp = new dfgNode(this);
...
// dfgNode* DFGPartPredLight::insertMergeNodeBeforeSEL(dfgNode* SELNode, dfgNode* ctrl,
...
// dfgNode* DFGPartPredLight::insertMergeNode(dfgNode* PHINode, dfgNode* ctrl,
// 		bool controlVal, int val) {
...
// void DFGPartPredLight::removeDisconnetedNodes() {
 ...
 *
 * */
// int DFGPartPredLight::handleSELECTNodes() {
...
// dfgNode* DFGPartPredLight::combineConditionAND(dfgNode* brcond, dfgNode* selcond, dfgNode* child) {
// 	dfgNode* temp = new dfgNode(this);
...
// bool DFGPartPredLight::checkBackEdge(dfgNode* src, dfgNode* dest) {
// 	//	dfgNode* firstnode = NodeList[0];
// 	//	SmallVector<std::pair<const BasicBlock *, const BasicBlock *>,8> BackedgeBBs;
// 	//	FindFunctionBackedges(*(firstnode->getNode()->getFunction()),BackedgeBBs);
...
// bool DFGPartPredLight::checkPHILoop(dfgNode* node1, dfgNode* node2) {
...
// bool DFGPartPredLight::checkBRPath(const BranchInst* BRParentBRI, const BasicBlock* currBB, bool& condVal,  std::set<const BasicBlock*>& searchedSoFar) {
// 	if(BRParentBRI->getSuccessor(0)==currBB){
// 		condVal=true;
// 		return true;
// 	}
...
// void DFGPartPredLight::scheduleCleanBackedges() {
...
// void DFGPartPredLight::fillCMergeMutexNodes() {
 ...
 *
 */
// void DFGPartPredLight::constructCMERGETree() {
...
// void DFGPartPredLight::scheduleALAP() {
...
// void DFGPartPredLight::balanceSched() {
...
// int DFGPartPredLight::classifyParents() {
...
// void DFGPartPredLight::assignALAPasASAP() {
...
// void DFGPartPredLight::addRecConnsAsPseudo() {
...
// void DFGPartPredLight::addOrphanPseudoEdges() {
...
// dfgNode* DFGPartPredLight::addLoadParent(Value* ins, dfgNode* child) {
// 	dfgNode* temp;
...
// void DFGPartPredLight::printDOT(std::string fileName) {
// 	std::ofstream ofs;
 ...
 * */
// void DFGPartPredLight::printDOTsimple(std::string fileName) {
// 	std::ofstream ofs;
// 	ofs.open(fileName.c_str());
...
// void DFGPartPredLight::connectBBTrig() {
...
// void DFGPartPredLight::createCtrlBROrTree() {
...
// std::map<BasicBlock*, std::set<std::pair<BasicBlock*, CondVal> > > DFGPartPredLight::getCtrlInfoBBMorePaths() {
...
// int findParentClassificationLight(dfgNode* par, dfgNode* child){
...
// void DFGPartPredLight::RemoveInductionControlLogic() {
...
// 		int par_class = findParentClassificationLight(ind_phi_node,phiC);
// 		assert(par_class!=-1);
...
// 	int phi_init_class = findParentClassificationLight(ind_phi_init_par,ind_phi_node);
...
// void DFGPartPredLight::RemoveBackEdgePHIs() {
...
// 						Edge2OperandIdxMap[normal_anc][phiC] = findParentClassificationLight(n,phiC);

// 						if(phiC->getNameType() == "CMERGE") cmergeDataInputs[phiC]=normal_anc;

// 						// phiC->parentClassification[findParentClassificationLight(n,phiC)]=normal_anc;
// 					}
...
// 							Edge2OperandIdxMap[dataParent][phiC] = findParentClassificationLight(n,phiC);
...
// 							// phiC->parentClassification[findParentClassificationLight(n,phiC)]=dataNode;
// 						}
// 					}
...
// 						Edge2OperandIdxMap[backedge_anc][phiC] = findParentClassificationLight(n,phiC);

// 						if(phiC->getNameType() == "CMERGE") cmergeDataInputs[phiC]=backedge_anc;
// 						// phiC->parentClassification[findParentClassificationLight(n,phiC)]=backedge_anc;
...
// void DFGPartPredLight::RemoveConstantCMERGEs(){
...
// void DFGPartPredLight::getLoopExitConditionNodes(std::set<exitNode> &exitNodes)
// {
...
// void DFGPartPredLight::addLoopExitStoreHyCUBE(std::set<exitNode> &exitNodes)
// {
