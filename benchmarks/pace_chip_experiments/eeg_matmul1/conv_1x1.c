...
int8_t data[564];
int8_t kernel[144];
int8_t conv_1x1[564];// tvm target: c -keys=cpu 
...
TVM_DLL int32_t conv_main(void* args, int32_t* arg_type_ids, int32_t num_args, void* out_ret_value, int32_t* out_ret_tcode, void* resource_handle) {
  ...
  for (int32_t j_outer = 0; j_outer < 4; ++j_outer) {
    ...
    for (int32_t j_inner_i_fused = 0; j_inner_i_fused < 141; ++j_inner_i_fused) {
      ...
      int32_t cse_var_4 = div_47_i;
      int32_t cse_var_3 = (div_47_j * 12);
      int32_t cse_var_2 = (cse_var_5 + cse_var_4);
      int32_t cse_var_1 = ((cse_var_3 + cse_var_5) + cse_var_4);
      ((int8_t*)conv_1x1)[cse_var_1] = (int8_t)0;
      ((int8_t*)conv_1x1)[cse_var_1] = (((int8_t*)conv_1x1)[cse_var_1] + (((int8_t*)data)[cse_var_3] * ((int8_t*)kernel)[cse_var_2]));
      ((int8_t*)conv_1x1)[cse_var_1] = (((int8_t*)conv_1x1)[cse_var_1] + (((int8_t*)data)[(cse_var_3 + 1)] * ((int8_t*)kernel)[(cse_var_2 + 12)]));
      ((int8_t*)conv_1x1)[cse_var_1] = (((int8_t*)conv_1x1)[cse_var_1] + (((int8_t*)data)[(cse_var_3 + 2)] * ((int8_t*)kernel)[(cse_var_2 + 24)]));
      ((int8_t*)conv_1x1)[cse_var_1] = (((int8_t*)conv_1x1)[cse_var_1] + (((int8_t*)data)[(cse_var_3 + 3)] * ((int8_t*)kernel)[(cse_var_2 + 36)]));
      ((int8_t*)conv_1x1)[cse_var_1] = (((int8_t*)conv_1x1)[cse_var_1] + (((int8_t*)data)[(cse_var_3 + 4)] * ((int8_t*)kernel)[(cse_var_2 + 48)]));
      ((int8_t*)conv_1x1)[cse_var_1] = (((int8_t*)conv_1x1)[cse_var_1] + (((int8_t*)data)[(cse_var_3 + 5)] * ((int8_t*)kernel)[(cse_var_2 + 60)]));
      ((int8_t*)conv_1x1)[cse_var_1] = (((int8_t*)conv_1x1)[cse_var_1] + (((int8_t*)data)[(cse_var_3 + 6)] * ((int8_t*)kernel)[(cse_var_2 + 72)]));
      ((int8_t*)conv_1x1)[cse_var_1] = (((int8_t*)conv_1x1)[cse_var_1] + (((int8_t*)data)[(cse_var_3 + 7)] * ((int8_t*)kernel)[(cse_var_2 + 84)]));
      ((int8_t*)conv_1x1)[cse_var_1] = (((int8_t*)conv_1x1)[cse_var_1] + (((int8_t*)data)[(cse_var_3 + 8)] * ((int8_t*)kernel)[(cse_var_2 + 96)]));
      ((int8_t*)conv_1x1)[cse_var_1] = (((int8_t*)conv_1x1)[cse_var_1] + (((int8_t*)data)[(cse_var_3 + 9)] * ((int8_t*)kernel)[(cse_var_2 + 108)]));
      ((int8_t*)conv_1x1)[cse_var_1] = (((int8_t*)conv_1x1)[cse_var_1] + (((int8_t*)data)[(cse_var_3 + 10)] * ((int8_t*)kernel)[(cse_var_2 + 120)]));
      ((int8_t*)conv_1x1)[cse_var_1] = (((int8_t*)conv_1x1)[cse_var_1] + (((int8_t*)data)[(cse_var_3 + 11)] * ((int8_t*)kernel)[(cse_var_2 + 132)]));
...
int main() {
    ...
    type_data.bits = 8;
    type_data.lanes = 1;
    read_int8_data("conv_1x1_data.txt", data, 564);
    DLTensor dlt_data;
    ...
    type_kernel.bits = 8;
    type_kernel.lanes = 1;
    read_int8_data("conv_1x1_kernel.txt", kernel, 144);
    DLTensor dlt_kernel;
    ...
    // write out tensor
    if (write_int8_data("conv_1x1_output.txt", conv_1x1, 564) != 0) {
