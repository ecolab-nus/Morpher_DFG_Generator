...
int8_t data[60];
int8_t kernel[240];
int8_t fc[4];// tvm target: c -keys=cpu 
TVM_DLL int32_t conv_main(void* args, int32_t* arg_type_ids, int32_t num_args, void* out_ret_value, int32_t* out_ret_tcode, void* resource_handle) {
  ...
  for (int32_t j_outer = 0; j_outer < 4; ++j_outer) {
    ...
    for (int32_t j_inner_k_outer_fused = 0; j_inner_k_outer_fused < 10; ++j_inner_k_outer_fused) {
      ...
      ((int8_t*)fc)[j_outer] = (((int8_t*)fc)[j_outer] + (((int8_t*)data)[cse_var_2] * ((int8_t*)kernel)[cse_var_1]));
      ((int8_t*)fc)[j_outer] = (((int8_t*)fc)[j_outer] + (((int8_t*)data)[(cse_var_2 + 1)] * ((int8_t*)kernel)[(cse_var_1 + 4)]));
      ((int8_t*)fc)[j_outer] = (((int8_t*)fc)[j_outer] + (((int8_t*)data)[(cse_var_2 + 2)] * ((int8_t*)kernel)[(cse_var_1 + 8)]));
      ((int8_t*)fc)[j_outer] = (((int8_t*)fc)[j_outer] + (((int8_t*)data)[(cse_var_2 + 3)] * ((int8_t*)kernel)[(cse_var_1 + 12)]));
      ((int8_t*)fc)[j_outer] = (((int8_t*)fc)[j_outer] + (((int8_t*)data)[(cse_var_2 + 4)] * ((int8_t*)kernel)[(cse_var_1 + 16)]));
      ((int8_t*)fc)[j_outer] = (((int8_t*)fc)[j_outer] + (((int8_t*)data)[(cse_var_2 + 5)] * ((int8_t*)kernel)[(cse_var_1 + 20)]));
    }
  }
  return 0;
}
...
int main() {
    ...
    type_data.bits = 8;
    type_data.lanes = 1;
    read_int8_data("fc_data.txt", data, 60);
    DLTensor dlt_data;
    ...
    type_kernel.bits = 8;
    type_kernel.lanes = 1;
    read_int8_data("fc_kernel.txt", kernel, 240);
    DLTensor dlt_kernel;
    ...
    // write out tensor
    if (write_int8_data("fc_output.txt", fc, 4) != 0) {
