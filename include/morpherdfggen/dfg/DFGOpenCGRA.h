#ifndef DFGOPENCGRA_H
#define DFGOPENCGRA_H
...
class DFGOpenCGRA : public DFG{
public :
	DFGOpenCGRA(std::string name,std::map<Loop*,std::string>* lnPtr, Loop* l) : DFG(name,lnPtr), currLoop(l){}
	void connectBB();
